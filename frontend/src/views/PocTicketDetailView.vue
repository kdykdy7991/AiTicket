...
import { MAIN_FLOW_STATES, POC_PRIORITY_OPTIONS, VERIFICATION_STATUS_OPTIONS, actionLabel, priorityLabel, roleLabel, stateLabel, stateType, type PocState, type TicketAction } from '@/domain/pocWorkflow'
